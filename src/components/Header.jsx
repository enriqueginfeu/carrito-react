...
export const Header = ({ productos, setProductos, total, setTotal, contadorProductos, setContadorProductos}) => {

  const [active, setActive] = useState(false)
  
  const eliminarProducto = (producto) => {
    const resultado = productos.filter(item => item.id !== producto.id)
